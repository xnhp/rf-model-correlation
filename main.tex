...
\marginnote{
Here, $\alpha_i$ are weights. These can be chosen such that $\bar{q}$ is a mean; then this corresponds to the combination methods of Random Forests. Otherwise, particularly with decreasing weights $\alpha_i$ this is exactly the formulation of boosting (\cite{anyboost, ...}). 
}
