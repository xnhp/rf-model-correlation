...
% TODO wording, cannot use "at this point not yet clear, cannot assume reader goes linearly from start to end
$$
...
\sidenote{
For a metric $d:X \times X \to \mathbb{R}$ and $a,b,c \in X$, due to the triangle inequality, it holds that
\begin{align*}
& d(a,b) - d(b,c)  \\
